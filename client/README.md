...
- [Proxying API Requests in Development](#proxying-api-requests-in-development)
  - ['Invalid Host TableHeader' Errors After Configuring Proxy](#invalid-host-header-errors-after-configuring-proxy)
...
### 'Invalid Host TableHeader' Errors After Configuring Proxy
